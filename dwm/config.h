...
static char fore[]   = "#e5e9f0";
static char back[]   = "#0f111a";
static char border[] = "#3a575c";
static char accent[] = "#FF4151";
static char col0[]   = "#3b4252"; /* dark gray */
static char col1[]   = "#bf616a"; /* red */
static char col2[]   = "#a3be8c"; /* green */
static char col3[]   = "#ebcb8b"; /* yellow */
static char col4[]   = "#81a1c1"; /* light_blue */
static char col5[]   = "#a48ead"; /* puple */
static char col6[]   = "#88c0d0"; /* blue */
static char col7[]   = "#e5e9f0"; /* white */
static char col8[]   = "#4c566a"; /* gray */

static char *colors[][ColCount] = {
	/*                       fg                bg                border                float boarder */
	[SchemeNorm]         = { fore,             back,             border,               border        },
	[SchemeSel]          = { fore,             back,             accent,               accent        },
	[SchemeTitleNorm]    = { fore,             back,             border,               border        },
	[SchemeTitleSel]     = { back,             accent,           border,               border        },
